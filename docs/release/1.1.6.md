...
More information can be found online in the [Cafienne Guide](/docs/api/case-team)
...
More information and examples can be found in the [Cafienne Guide on Business Identifiers](/docs/extensions/business-identifiers)
...
The Cafienne Guide has a new page called [Repository](/docs/engine/repository) describing the details.
